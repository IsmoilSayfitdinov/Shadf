...
async def process_excel_upload(message: types.Message, state: FSMContext):
    try:
        ...
        file_name = f"/home/320maktab/Shadf/{message.document.file_name}" 
        await bot.download_file(file_path, f"/home/320maktab/Shadf/{message.document.file_name}")

        # Excel faylini o'qish
        df = pd.read_excel(f"/home/320maktab/Shadf/{message.document.file_name}")
